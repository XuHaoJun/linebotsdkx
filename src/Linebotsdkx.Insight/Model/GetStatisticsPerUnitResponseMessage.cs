...
namespace Linebotsdkx.Insight.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetStatisticsPerUnitResponseMessage")]
    public partial class GetStatisticsPerUnitResponseMessage : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetStatisticsPerUnitResponseMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetStatisticsPerUnitResponseMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetStatisticsPerUnitResponseMessage" /> class.
        /// </summary>
        /// <param name="seq">Bubble&#39;s serial number. (required).</param>
        ...
        /// <param name="uniqueImpression">Number of users the bubble was displayed..</param>
        ...
        public GetStatisticsPerUnitResponseMessage(int seq = default(int), long? impression = default(long?), long? mediaPlayed = default(long?), long? mediaPlayed25Percent = default(long?), long? mediaPlayed50Percent = default(long?), long? mediaPlayed75Percent = default(long?), long? mediaPlayed100Percent = default(long?), long? uniqueImpression = default(long?), long? uniqueMediaPlayed = default(long?), long? uniqueMediaPlayed25Percent = default(long?), long? uniqueMediaPlayed50Percent = default(long?), long? uniqueMediaPlayed75Percent = default(long?), long? uniqueMediaPlayed100Percent = default(long?))
        {
            this.Seq = seq;
