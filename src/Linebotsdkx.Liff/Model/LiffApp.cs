...
namespace Linebotsdkx.Liff.Model
{
    ...
    /// LiffApp
    /// </summary>
    [DataContract(Name = "LiffApp")]
    public partial class LiffApp : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LiffApp" /> class.
        /// </summary>
        /// <param name="liffId">LIFF app ID.</param>
        /// <param name="view">view.</param>
        /// <param name="description">Name of the LIFF app.</param>
        /// <param name="features">features.</param>
        /// <param name="permanentLinkPattern">How additional information in LIFF URLs is handled. concat is returned. .</param>
        /// <param name="scope">scope.</param>
        /// <param name="botPrompt">botPrompt.</param>
        public LiffApp(string liffId = default(string), LiffView view = default(LiffView), string description = default(string), LiffFeatures features = default(LiffFeatures), string permanentLinkPattern = default(string), List<LiffScope> scope = default(List<LiffScope>), LiffBotPrompt? botPrompt = default(LiffBotPrompt?))
        {
            this.LiffId = liffId;
            this.View = view;
