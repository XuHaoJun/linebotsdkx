...
namespace Linebotsdkx.Liff.Model
{
    ...
    /// AddLiffAppRequest
    /// </summary>
    [DataContract(Name = "AddLiffAppRequest")]
    public partial class AddLiffAppRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddLiffAppRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddLiffAppRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddLiffAppRequest" /> class.
        /// </summary>
        ...
        public AddLiffAppRequest(LiffView view = default(LiffView), string description = default(string), LiffFeatures features = default(LiffFeatures), string permanentLinkPattern = default(string), List<LiffScope> scope = default(List<LiffScope>), LiffBotPrompt? botPrompt = default(LiffBotPrompt?))
        {
            // to ensure "view" is required (not null)
            if (view == null)
            {
                throw new ArgumentNullException("view is a required property for AddLiffAppRequest and cannot be null");
            }
            this.View = view;
