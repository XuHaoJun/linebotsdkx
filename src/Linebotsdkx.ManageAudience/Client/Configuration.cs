...
namespace Linebotsdkx.ManageAudience.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.0.4/csharp");
            ...
            {
                {
                    "ManageAudienceBlobApi.AddUserIdsToAudience", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ManageAudienceBlobApi.CreateAudienceForUploadingUserIds", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
        ...
        {
            string report = "C# SDK (Linebotsdkx.ManageAudience) Debug Report:\n";
